...
//
// If you added or removed values in variables.yaml (or declared a
// different enum variable), edit this script to match. The generator
// emits Yarn that references these exact strings.
